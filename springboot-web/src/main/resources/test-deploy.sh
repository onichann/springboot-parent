...
svn checkout https://180.169.88.114:6443/svn/hr/trunk/test/back /zzz/hr/test/svn/test/back --username yangzhouchuan --password Yzc135.
...
svn checkout https://180.169.88.114:6443/svn/hr/trunk/test/front /zzz/hr/test/svn/test/front --username yangzhouchuan --password Yzc135.
